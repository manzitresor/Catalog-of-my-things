...
RSpec.describe Genre do
  ...
  describe '#add_item' do
    it 'adds an item to the genre' do
        ...
        item = Item.new('Example Genre', 'Example Author', 'Example Source', 'Example Label') # Provide the required arguments
    ...
    it 'does not add invalid items to the genre' do
      ...
      expect { genre.add_item(invalid_item) }.to output("Invalid item. Please provide an instance of the Item class.\n").to_stdout
