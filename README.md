...
**catalog od my things PROJECT** is console app that will help you to keep a record of different types of things you own: books, music albums, movies, and games.
...
```bash
  git clone https://github.com/manzitresor/Catalog-of-my-things.git
```
...
- GitHub: [@githubhandle](https://github.com/addisalemseifu)
